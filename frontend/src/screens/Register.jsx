  ...
  return (
    <div className="flex items-center justify-center bg-slate-300 h-screen">
      <div className="flex flex-col justify-center items-center rounded-lg bg-white w-80 text-center p-2 h-max px-4">
        ...
        <p className="text-mb px-4 pt-1 pb-4 mb-9 text-gray-500">
        ...
        <div className="flex flex-col gap-5 w-full px-3">
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              className="border border-slate-300 px-2 h-9 rounded"
              type="text"
          ...
          <button
            ...
            className="bg-black text-white h-[36px] border rounded font-semibold hover:bg-white hover:text-black"
          >
            Submit
          </button>
        </div>
        ...
        <div className="flex text-sm py-2">
          ...
          <Link className="pl-1 underline" to={"/login"}>
            Sign In
          </Link>
        </div>
      </div>
